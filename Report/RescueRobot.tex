...
% affiliations
\author{\IEEEauthorblockN{\textbf{Bruno Berger}}
\IEEEauthorblockA{\textbf{Matrikelnr.2170706}\\Hochschule Hamm-Lippstadt\\Interaktionstechnik und Design\\
Dr.-Arnold-Hueck-Straße 3\\ 59557 Lippstadt\\
Email: bruno.berger@stud.hshl.de}
\and
\IEEEauthorblockN{\textbf{Lukas Walter}}
\IEEEauthorblockA{\textbf{Matrikelnr.2170086}\\Hochschule Hamm-Lippstadt\\Interaktionstechnik und Design\\
Dr.-Arnold-Hueck-Straße 3\\ 59557 Lippstadt\\
Email: lukas.walter@stud.hshl.de}
\and
\IEEEauthorblockN{\textbf{Melanie Löbel}}
\IEEEauthorblockA{\textbf{Matrikelnr.2170582}\\Hochschule Hamm-Lippstadt\\Interaktionstechnik und Design\\
Dr.-Arnold-Hueck-Straße 3\\ 59557 Lippstadt\\
...
\input{Sections/Sketch of approach}
\input{Sections/Concept part}
\input{Sections/Evaluation}
\input{Sections/Summary and outlook}
\input{Sections/Appendix} % conference papers do not normally have an appendix
